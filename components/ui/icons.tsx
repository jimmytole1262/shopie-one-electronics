 ...
 * This file serves as a centralized place for all custom icon components
 */
...
export function UserPlus({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={cn("lucide lucide-user-plus", className)}
    >
...
export function UserMinus({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function MoreHorizontal({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={cn("lucide lucide-more-horizontal", className)}
    >
